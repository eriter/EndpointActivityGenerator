...
file_activity_generator = FileActivityGenerator.new(OUTPUT_DIRECTORY, $PROGRAM_NAME, TEST_FILE_PATH, TEST_FILE_TYPE)
...
file_activity_generator.create_file(activity_logger)
file_activity_generator.modify_file(activity_logger)
file_activity_generator.delete_file(activity_logger)
